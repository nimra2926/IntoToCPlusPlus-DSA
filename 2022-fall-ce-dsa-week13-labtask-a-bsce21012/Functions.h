//
// Created by Lenovo on 11/22/2022.
//

#ifndef INC_2022_FALL_CE_DSA_WEEK13_LABTASK_A_BSCE21012_FUNCTIONS_H
#define INC_2022_FALL_CE_DSA_WEEK13_LABTASK_A_BSCE21012_FUNCTIONS_H

#endif //INC_2022_FALL_CE_DSA_WEEK13_LABTASK_A_BSCE21012_FUNCTIONS_H
...
public:
    ...
    void check1(int value) const {
        int temp = 0;
        for (int i = 0; i < size; i++) {
            if (array[i].checking(value) ==
                1) {                  //if the flag from the upper function is 1 then increment temp
